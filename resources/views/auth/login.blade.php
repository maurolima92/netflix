<x-guest-layout>
    <x-auth-card>       
        ...
        <h3 class=" text-white font-bold text-2xl mb-7"> Entrar</h3>
        ...
        <form method="POST" action="{{ route('login') }}" >
            ...
            <div class="mt-4">
                ...
                <x-input id="password" placeholder="Senha" class="block mt-1 w-full"
                                type="password"
                                name="password"
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-button class=" bg-primary w-full px-10 py-3 weight-700 text-center text-lg " >
                    {{ __('Entrar') }}
                </x-button>
            </div>
        </form>

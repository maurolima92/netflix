                                ...
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    <div class="grid grid-cols-1 gap-6">
                                        <div class="col-span-3 sm:col-span-2">
                                            ...
                                            <input type="text" name="title" id="title" value="{{ old('title') }}" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="As tranças do rei careca">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm"> 
                                                ...
                                                @foreach ($categories as $categorie)
                                                    <option id="{{$categorie->id}}"  value="{{$categorie->id}}">{{$categorie->title}}</option>
                                                @endforeach
                                                </select>
                                    ...
                                    <div>
                                        <label for="description" class="block text-sm font-medium text-gray-700"> Descrição </label>
                                            <div class="mt-1">
                                                <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Capriche na descrição do seu vídeo">{{ old('description') }}</textarea>
                                            </div>        
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-6">
                                        <div class="col-span-3 sm:col-span-2">
                                            ...
                                            <input type="text" name="url" id="url" value="{{old('url')}}" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="www.example.com">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="space-y-1 text-center">
                                                ...
                                                <div class="flex text-sm text-gray-600">
                                                    <label for="imagecp" class="relative cursor-pointer bg-white rounded-md font-medium text-primary hover:text-darktransparent  focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                                        ...
                                                        <input id="imagecp" name="imagecp" value="{{old('imagecp')}}" type="file" class="">
                                                    </label>
                                                </div>
                                            ...
                                            <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                                ...
                                                <div class="flex text-sm text-gray-600">
                                                    <label for="imagebg" class="relative cursor-pointer bg-white rounded-md font-medium text-primary hover:text-darktransparent focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                                        ...
                                                        <input id="imagebg" name="imagebg" value="{{old('imagebg')}}" type="file" class="">
                                                    </label>
                                                </div>
                                                <p class="text-xs text-gray-500">PNG, JPG, GIF up to 1MB</p>
